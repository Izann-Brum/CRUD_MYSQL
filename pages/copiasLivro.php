...
use ConexaoPHPPostgres\LivroModel as LivrosModel;
use ConexaoPHPPostgres\NovaUnidadesModel as NovaUnidadeModel;
try {

    $NovaUnidadeModel = new NovaUnidadeModel($pdo);
    $Unidades = $NovaUnidadeModel->all();
    
    $LivrosModel = new LivrosModel($pdo);
    $Livros = $LivrosModel->getLivroAutor();
    $Books = $LivrosModel->getLivroCopias();
