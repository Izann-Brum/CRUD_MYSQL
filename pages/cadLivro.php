...
<table class="table">
	...
	<tr>
		...
		<option value="<?php echo ($Autor['Nome_autor'])?>"><?php echo htmlspecialchars($Autor['Nome_autor'])?></option>
		<?php endforeach; ?>
        ...
        <!-- <option value="<?php echo ($Editora['Nome'])?>"><?php echo htmlspecialchars($Editora['Nome'])?></option> ANTES -->
		<?php endforeach; ?>
		</select></center></td>
